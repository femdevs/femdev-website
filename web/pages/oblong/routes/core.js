...
router
    .get("/", async (req, res) =>
        res.render("pages/oblong/index.pug", {
    ...
    .use((req, res, next) => {
        ...
        let allowedMethods = router.stack.filter(
            (routerObj) => routerObj.route && routerObj.route.path === path,
        );
    ...
    .use((req, res, _) =>
        res
            .status(404)
            .render("misc/404.pug", req.getErrPage(404, { path: req.path })),
    );
