	...
	.set(400, _ => (
		{
			meta: {
				...
				canonical: "https://thefemdevs.com/errors/400",
			},
		}
	))
	.set(401, data => (
		{
			...
			meta: {
				...
				canonical: "https://thefemdevs.com/errors/401",
			},
		}
	))
	.set(403, _ => (
		{
			...
			meta: {
				...
				canonical: "https://thefemdevs.com/errors/403",
			},
		}
	))
	.set(404, _ => (
		{
			meta: {
				...
				canonical: 'https://thefemdevs.com/errors/404',
			},
		}
	))
	.set(405, data => (
		{
			...
			meta: {
				...
				canonical: 'https://thefemdevs.com/errors/405',
			},
		}
	))
	.set(429, _ => (
		{
			meta: {
				...
				canonical: 'https://thefemdevs.com/errors/429',
			},
		}
	))
	.set(451, _ => (
		{
			meta: {
				...
				canonical: "https://thefemdevs.com/errors/location",
			},
		}
	))
	.set(501, _ => (
		{
			meta: {
				...
				canonical: "https://thefemdevs.com/errors/501",
			},
		}
	));
