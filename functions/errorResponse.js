...
module.exports = new Map()
	...
	.set(6,  new ErrorData(400, 6,  'Missing Query Parameter(s)'))
	.set(7,  new ErrorData(400, 7,  'Invalid Query Parameter(s)'))
	.set(8,  new ErrorData(400, 8,  'Missing Header Parameter(s)'))
	.set(9,  new ErrorData(400, 9,  'Invalid Header Parameter(s)'))
	.set(10, new ErrorData(400, 10, 'Missing Body Parameter(s)'))
	.set(11, new ErrorData(400, 11, 'Invalid Body Parameter(s)'))
	...
	.set(22, new ErrorData(404, 22, 'Unable to retrieve requested information'))
